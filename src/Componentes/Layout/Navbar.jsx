                ...
                <ul className="flex items-center gap-6">
                    ...
                    <li>
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `${linkClass} ${isActive ? "text-orange-400" : scrolled ? "text-white/80" : "text-gray-800"}`
                            }
                        >
                            Home
                        </NavLink>
                    ...
                    {usuario && (usuario.rol ?? usuario.Rol ?? "").toString().toLowerCase() === "admin" && (
                        <li className="relative">
                            <button
                                ...
                                className={`${linkClass} px-3 py-1.5 rounded-md flex items-center gap-2 ${scrolled ? "text-white/80" : "text-gray-800"}`}
                            >
                                Admin
                            ...
                            {adminOpen && (
                                <div className={`absolute right-0 mt-2 w-44 rounded-md shadow-lg z-30 ${scrolled ? "bg-gray-800 text-white" : "bg-white text-gray-800"}`}>
                                    <NavLink to="/admin/platos" onClick={() => setAdminOpen(false)}
                                        className={({ isActive }) => `block px-4 py-2 text-sm hover:bg-orange-100 ${isActive ? "bg-orange-200" : ""}`}>
                                        Platos
                                    </NavLink>
                                    <NavLink to="/admin/generos" onClick={() => setAdminOpen(false)}
                                        className={({ isActive }) => `block px-4 py-2 text-sm hover:bg-orange-100 ${isActive ? "bg-orange-200" : ""}`}>
                                        Géneros
                                    </NavLink>
                                    <NavLink to="/admin/categorias" onClick={() => setAdminOpen(false)}
                                        className={({ isActive }) => `block px-4 py-2 text-sm hover:bg-orange-100 ${isActive ? "bg-orange-200" : ""}`}>
                                        Categorías
                                    </NavLink>
                                </div>
                    ...
                    {/* Links de usuario logueado o botón login */}
                    <li>
                        {usuario ? (
                            <div className="flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className={`text-sm transition ${scrolled ? "text-white/70 hover:text-white" : "text-gray-600 hover:text-black"}`}
                                >
                                    Salir
                                </button>
                            </div>
