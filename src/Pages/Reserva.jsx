...
const Reserva = () => {
    ...
    const generoNombre = generos.find((g) => Number(g.id_genero) === Number(genero))?.nombre ?? genero;

    if (enviado) {
        return (
            <div className="min-h-full flex-1 flex items-center justify-center px-4 py-12"
                ...
                <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-md text-center">
                    ...
                    <p className="text-gray-500 text-sm mb-6">
                        Gracias, {nombre}. Tu voto por <strong>{generoNombre}</strong> quedó
            ...
            <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-lg">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <p className="text-gray-400 text-sm text-center">
                        {sede ? `Sede: ${sede}` : "Completa tus datos y vota por tu género favorito"}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="fecha" className="text-sm font-medium text-gray-700 block mb-1">
                                Fecha
                            </label>
                            <input
                                id="fecha"
                        ...
                        <div>
                            <label htmlFor="hora" className="text-sm font-medium text-gray-700 block mb-1">
                                Hora
                            </label>
                            <select
                                id="hora"
